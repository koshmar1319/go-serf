...
<kbd> <img width="900" height="auto" align="center" alt="Превью проекта" src="./go_surf_preview.jpg"> </kbd>
...
>  В проекте активно используются `Flex`, `анимации`, `позиционирование`, `псевдоэлементы`, `псевдоклассы`,  `БЭМ` и т.д.
...
```sh
git clone https://github.com/koshmar1319/go-serf.git
```
...
### Демо:
> Github Pages <br/>[Ссылка на сайт :arrow_lower_right:](https://koshmar1319.github.io/go-serf/index.html "ссылка на сайт")
